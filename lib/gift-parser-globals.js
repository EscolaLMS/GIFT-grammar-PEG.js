...
(function(root) {
  ...
  function peg$parse(input, options) {
    ...
    var peg$FAILED = {},
        ...
        peg$c116 = peg$otherExpectation("(escape character)"),
        peg$c117 = "\\",
        peg$c118 = peg$literalExpectation("\\", false),
        peg$c119 = peg$otherExpectation("escape sequence"),
        peg$c120 = "~",
        peg$c121 = peg$literalExpectation("~", false),
        peg$c122 = function(sequence) { return sequence },
        peg$c123 = peg$otherExpectation(""),
        peg$c124 = peg$anyExpectation(),
        peg$c125 = function() {return text()},
        peg$c126 = peg$otherExpectation("(formatted text excluding '->'"),
        peg$c127 = function(format, txt) { return {
              format:(format!==null ? format : getLastQuestionTextFormat()), 
              text:((format !== "html") 
                  ? removeDuplicateSpaces(txt.join('').trim())
                  : txt.join('').replace(/\r\n/g,'\n'))}},
        peg$c128 = peg$otherExpectation("(formatted text)"),
        peg$c129 = function(format, txt) { return {
              format:(format!==null ? format : getLastQuestionTextFormat()), 
              text:((format !== "html") 
                 ? removeDuplicateSpaces(txt.join('').trim())
                 : txt.join('').replace(/\r\n/g,'\n'))}},
        peg$c130 = peg$otherExpectation("(unformatted text)"),
        peg$c131 = function(txt) { return removeNewLinesDuplicateSpaces(txt.join('').trim())},
        peg$c132 = peg$otherExpectation("(category text)"),
        peg$c133 = function(txt) { return txt.flat().join('') },
        peg$c134 = function(chars, frac) { return parseFloat(chars.join('') + frac); },
        peg$c135 = ".",
